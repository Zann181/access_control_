...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : RING_Pin COLUMN_2_Pin COLUMN_3_Pin */
  GPIO_InitStruct.Pin = RING_Pin|COLUMN_2_Pin|COLUMN_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  ...
  /*Configure GPIO pin : LD_RING_Pin */
  GPIO_InitStruct.Pin = LD_RING_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LD_RING_GPIO_Port, &GPIO_InitStruct);
